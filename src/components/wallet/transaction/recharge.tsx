...
import { getRechargeTransactions } from "@data/transaction";
import { UnauthorizedError } from "@lib/error";
import { getTranslations } from "@lib/translation";
import NextImage from "next/image";

export default async function WalletRechargeTransactions() {
  const t = await getTranslations();
  const transactions = await getRechargeTransactions().catch((error: unknown) => {
