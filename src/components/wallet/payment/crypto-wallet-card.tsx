...
import { select } from "@action/payment/crypto";
...
export default function CryptoWalletCard(props: BankCardProps) {
  ...
  return (
    <div className="overflow-hidden rounded-md bg-red-50">
      <header className="flex gap-2.5 bg-red-300 p-2.5 text-white">
        <Usdt size={rem(20)} />
        <strong className="truncate text-sm">{props.network}</strong>
      </header>

      <div className="flex flex-col px-2.5 py-5">
        <strong className="truncate text-lg">{props.account}</strong>
