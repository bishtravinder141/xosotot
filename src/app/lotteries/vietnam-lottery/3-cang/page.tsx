...
type VietnamLottery3CangPageProps = {
  searchParams: {
    area?: string;
    date?: string;
    page?: string;
...
export default async function VietnamLottery3CangPage(props: VietnamLottery3CangPageProps) {
  ...
  return (
    <LotteryProvider>
      ...
      <LotteryTabsProvider initial="3">
        <TabsContent value="3">
          <LotteryRules>{t("lottery.vietnam-lottery.3-cang.rules.0")}</LotteryRules>
        </TabsContent>
        ...
        <Suspense fallback={<Skeleton className="h-14 rounded-xl" />}>
          <VietnamLotteryPreviousResult area={area} city={cityName} title="3 càng" />
        </Suspense>
        ...
        <TabsContent value="3">
          <CombinationProvider size={3} type="3">
            ...
            <TabsContent value="history">
              <div className="min-w-max scroll-mt-20 space-y-2.5 overflow-x-auto">
                ...
                <Suspense fallback={<LotteryRecordsSkeleton limit={20} />}>
                  <LotteryVietnamLotteryHistory area={area} city={cityName} page={page} title="3 càng" />
                </Suspense>
              </div>
            </TabsContent>
            ...
            <TabsContent value="bet history">
              ...
              <div className="min-w-max scroll-mt-20 space-y-2.5 overflow-x-auto">
                <Suspense fallback={<LotteryDetailsSkeleton limit={20} />}>
                  <LotteryVietnamLotteryDetails page={page} title="3 càng" />
                </Suspense>
              </div>
            </TabsContent>
          </div>
