...
type VietnamLotteryLoXienPageProps = {
  searchParams: {
    area?: string;
    date?: string;
    page?: string;
...
export default async function VietnamLotteryLoXienPage(props: VietnamLotteryLoXienPageProps) {
  ...
  return (
    <LotteryProvider>
      ...
      <LotteryTabsProvider initial="1">
        <TabsContent value="1">
          <LotteryRules>
            {t("lottery.vietnam-lottery.lo-xien.rules.0", { prizes: [1, 2].includes(area) ? 18 : 27 })}
          </LotteryRules>
        </TabsContent>
        <TabsContent value="2">
          <LotteryRules>
            {t("lottery.vietnam-lottery.lo-xien.rules.1", { prizes: [1, 2].includes(area) ? 18 : 27 })}
          </LotteryRules>
        </TabsContent>
        <TabsContent value="3">
          <LotteryRules>
            {t("lottery.vietnam-lottery.lo-xien.rules.2", { prizes: [1, 2].includes(area) ? 18 : 27 })}
          </LotteryRules>
        </TabsContent>
        ...
        <Suspense fallback={<Skeleton className="h-14 rounded-xl" />}>
          <VietnamLotteryPreviousResult area={area} city={cityName} title="Lô xiên" />
        </Suspense>
        ...
        <TabsContent value="2">
          <CombinationProvider size={3} type="2">
            <div className="flex flex-col gap-1.5 rounded-xl bg-red-50 px-2.5 py-2">
              <strong className="text-[0.5rem] leading-3">{`${t("Picked combinations")}:`}</strong>
            ...
            <div className="flex items-center justify-between gap-2.5 rounded-xl border border-red-300 bg-red-50 px-2.5 py-2 text-[0.625rem]">
              <VietnamLotterySelectCombination className="p-3" size={3} />
            </div>
        ...
        <TabsContent value="3">
          <CombinationProvider size={4} type="3">
            <div className="flex flex-col gap-1.5 rounded-xl bg-red-50 px-2.5 py-2">
              <strong className="text-[0.5rem] leading-3">{`${t("Picked combinations")}:`}</strong>
            ...
            <div className="flex items-center justify-between gap-2.5 rounded-xl border border-red-300 bg-red-50 px-2.5 py-2 text-[0.625rem]">
              <VietnamLotterySelectCombination className="p-3" size={4} />
            </div>
            ...
            <TabsContent value="history">
              <div className="min-w-max scroll-mt-20 space-y-2.5 overflow-x-auto">
                ...
                <Suspense fallback={<LotteryRecordsSkeleton limit={20} />}>
                  <LotteryVietnamLotteryHistory area={area} city={cityName} page={page} title="Lô xiên" />
                </Suspense>
              </div>
            </TabsContent>
            ...
            <TabsContent value="bet history">
              ...
              <div className="min-w-max scroll-mt-20 space-y-2.5 overflow-x-auto">
                <Suspense fallback={<LotteryDetailsSkeleton limit={20} />}>
                  <LotteryVietnamLotteryDetails page={page} title="Lô xiên" />
                </Suspense>
              </div>
            </TabsContent>
          </div>
