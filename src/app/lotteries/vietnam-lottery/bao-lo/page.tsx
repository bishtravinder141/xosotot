...
type VietnamLotteryBaoLoPageProps = {
  searchParams: {
    area?: string;
    date?: string;
    page?: string;
...
export default async function VietnamLotteryBaoLoPage(props: VietnamLotteryBaoLoPageProps) {
  ...
  return (
    <LotteryProvider>
      ...
      <LotteryTabsProvider initial="1">
        <TabsContent value="1">
          <LotteryRules>
            {t("lottery.vietnam-lottery.bao-lo.rules.0", { prizes: [1, 2].includes(area) ? 18 : 27 })}
          </LotteryRules>
        </TabsContent>
        <TabsContent value="2">
          <LotteryRules>
            {t("lottery.vietnam-lottery.bao-lo.rules.1", { prizes: [1, 2].includes(area) ? 18 : 27 })}
          </LotteryRules>
        </TabsContent>
        ...
        <Suspense fallback={<Skeleton className="h-14 rounded-xl" />}>
          <VietnamLotteryPreviousResult area={area} city={cityName} title="BAO LÔ" />
        </Suspense>
            ...
            <TabsContent value="history">
              <div className="min-w-max scroll-mt-20 space-y-2.5 overflow-x-auto">
                ...
                <Suspense fallback={<LotteryRecordsSkeleton limit={20} />}>
                  <LotteryVietnamLotteryHistory area={area} city={cityName} page={page} title="BAO LÔ" />
                </Suspense>
              </div>
            </TabsContent>
            ...
            <TabsContent value="bet history">
              ...
              <div className="min-w-max scroll-mt-20 space-y-2.5 overflow-x-auto">
                <Suspense fallback={<LotteryDetailsSkeleton limit={20} />}>
                  <LotteryVietnamLotteryDetails page={page} title="BAO LÔ" />
                </Suspense>
              </div>
            </TabsContent>
          </div>
