  ...
  return (
    <>
      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">1. How to Register</h2>

        <ul className="list-decimal pl-3 text-[0.625rem]">
          <li>Fill your phone number</li>
          <li>Set your own password (6 Letters)</li>
          <li>Fill your Recommendatoin code</li>
      ...
      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">2. How to Betting</h2>

        <p className="text-[0.625rem]">Click start game then choose 1 minute, 3 minute, 5 minute or 10 minute.</p>
        ...
        <ul className="text-[0.625rem]">
          ...
          <li>Big: if the result shows 5,6,7,8,9 ( This company not allowed to place Illegal betting)</li>
          <li>Exp: Betting (Big and small together) or (Red and Green together) in the same time.</li>
        </ul>
      ...
      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">3. How to recharge</h2>

        <p className="text-[0.625rem]">
          Click Wallet Icon, Click The Recharge Button, and we have three ways to make a recharge ( UPI, BANK TRANSFER,
          USDT/CRYPTO )
        </p>
      ...
      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">4. How to Withdraw</h2>

        <p className="text-[0.625rem]">Click Wallet Icon, Click Withdraw Button.</p>
        ...
        <p className="text-[0.625rem]">Select Your Bank Account Or Add Your Bank Account</p>
        ...
        <p className="text-[0.625rem]">Input Your Login Password</p>
      ...
      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">5. Orders</h2>
      ...
      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">6. Promotion</h2>

        <p className="text-[0.625rem]">
          If you have a downline or referral member use your own link to register and if they make a recharge you can
          claim a reward.
        </p>
        ...
        <p className="text-[0.625rem]">
          The agent will get a minimum commission of 0.6 % (level 1) and 0.18% (level 2) from each transaction that is
          done by the referral (Added every day at 00:30 AM.)
        </p>
        ...
        <p className="text-[0.625rem]">
          If the accumulated transactions of the Referral reach a certain target, the agent will get an additional bonus
          with the following rebates.
        </p>
      </div>

      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">7. Forgot Password</h2>

        <p className="text-[0.625rem]">Click Forgot Password</p>
        ...
        <p className="text-[0.625rem]">Fill your mobile number</p>
        ...
        <p className="text-[0.625rem]">
          Click OTP then will send it to message to your number as your verification code
        </p>
        ...
        <p className="text-[0.625rem]">Enter Strongest new password, and Click Submit.</p>

        <PreviewContainer className="py-2">
          <PasswordField autoComplete="new-password" name="password" placeholder={t("Your password")} required />
        </PreviewContainer>

        <p className="text-[0.625rem]">If Cannot Receive OTP Please Contact Customer Service Immediately.</p>
      ...
      <div className="rounded-md-lg space-y-4 rounded-xl bg-blue-100 px-3 py-4">
        <h2 className="text-sm font-bold text-blue-500">7. About</h2>

        <p className="text-[0.625rem]">
          Click About for more details regarding Privacy Policy and Risk Disclosure Agreement.
        </p>
